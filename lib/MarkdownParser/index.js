...
var MarkdownParser = function (_Component) {
  ...
  _createClass(MarkdownParser, [{
    ...
    value: function componentDidMount() {
      ...
      if (this.props.src) {
        axios(this.props.src).then(function (res) {
          var html = marked(res.data, _this2.props.option);
    ...
    value: function render() {
      return React.createElement('div', { className: this.props.className, dangerouslySetInnerHTML: { __html: this.state.html } });
    }
  }]);
