...
var PAGE_SIZE = gridConfig.defaultPageSize;
var KEYS = gridConfig;
...
var Grid = function (_Component) {
  ...
  function Grid(props) {
    ...
    _this.onChange = function (pagination, filters, sorter) {
      ...
      var params = (_params = {}, _defineProperty(_params, KEYS.getPage, pagination.current), _defineProperty(_params, KEYS.pageSize, pagination.pageSize), _params);
  ...
  _createClass(Grid, [{
    ...
    value: function getData(params) {
      ...
      params = params || (_ref = {}, _defineProperty(_ref, KEYS.getPage, _.get(this.state, 'pagination.current', 1)), _defineProperty(_ref, KEYS.pageSize, _.get(this.state, 'pagination.pageSize', PAGE_SIZE)), _ref);
      this.setState({
        loading: true
      });
      this.props.api(Object.assign({}, lastHistory, params, this.props.params)).then(function (res) {
        ...
        res.data[KEYS.list].forEach(function (x, index) {
