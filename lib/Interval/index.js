  ...
  function Interval(props) {
    ...
    _this.setText = function (time, second) {
      ...
      if (_this.props.render) {
        text = _this.props.render(time, second, _this.props.interval);
      }
...
Interval.defaultProps = {
  ...
  render: function render(time, second, interval) {
    return '\u6BCF' + Math.round(interval / 60) + '\u5206\u949F\u66F4\u65B0\u4E00\u6B21\uFF0C' + time + '\u540E\u66F4\u65B0';
  }, // 每次校验时执行函数，参数为倒计时字符串 (time, second) => time
